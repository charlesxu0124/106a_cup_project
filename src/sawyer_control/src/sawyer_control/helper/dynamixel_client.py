...
"""FAQ/common issues"""
"""
https://answers.ros.org/question/46612/dynamixel-motors-not-found/
You may need to run sudo chmod a+rw /dev/ttyUSB0
"""
...
ADDR_GOAL_CURRENT = 34
ADDR_PRESENT_POSITION = 36
ADDR_PRESENT_VELOCITY = 38
ADDR_PRESENT_CURRENT = 40
ADDR_PRESENT_POS_VEL_CUR = 42
...
import collections
MotorState = collections.namedtuple('MotorState', 'pos vel curr')
...
class DynamixelClient:
    ...
    def get_state(self):
        pos_now, vel_now, cur_now = self.read_pos_vel_cur()
        return MotorState(pos=pos_now, vel=vel_now, curr=cur_now)
